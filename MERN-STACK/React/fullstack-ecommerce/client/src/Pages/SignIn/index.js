        ...
        <section className="section signInPage">
          <div className="shape-bottom">
            <svg fill="#fff" id="Layer_1" x="0px" y="0px" viewBox="0 0 1921 819.8" style={{enableBackground:'new 0 0 1921 819.8'}}>
              <path className="st0" d="M1921,413.1v406.7H0V0.5h0.4l228.1,598.3c30.7,4.4,80.8,130.6,152.5,168.6c107.6,57,212.1,40.7,245.7,34.4
          ...
          <div className="container">
            <div className="box card p-3 shadow border-0">
                ...
                <h2 className="mb-4">Sign In</h2>
                   ...
                   <Link to="/">
                   <Button className=" btn-lg btn-big col ms-3" variant="outlined" onClick={() =>  context.setIsHeaderFooterShow(true)}>Cancel</Button>
                   </Link>
                   </div>
                   ...
                   <span className="loginWithGoogle" ><img src={GoogleImg} /></span>
                </form>
            </div>
          </div>
        </section>
