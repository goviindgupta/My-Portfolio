...
const SignUp = () => {
  ...
  return (
    <>
      <section className="section signInPage singUpPage">
        <div className="shape-bottom">
          ...
          >
            <path
              className="st0"
              d="M1921,413.1v406.7H0V0.5h0.4l228.1,598.3c30.7,4.4,80.8,130.6,152.5,168.6c107.6,57,212.1,40.7,245.7,34.4
          ...
          <div className="box card p-3 shadow border-0">
            ...
            <form className="mt-2">
              ...
              <div className="row w-100">
                <div className="col-md-6">
                <Button className="btn-blue btn-lg btn-big w-100 col">Sign In</Button>
                </div>
                <div className="col-md-6 pe-0">
                <Link to="/" className="d-block w-100">
                  <Button
                    className=" btn-lg btn-big col w-100"
                    variant="outlined"
